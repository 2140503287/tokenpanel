...
export function customerFixture(over: Partial<CustomerDoc> = {}): CustomerDoc {
  return {
    ...
    name: "Bob Corp",
    email: "bob@corp.com",
    balance: { amountMicros: 100_000_000, reservedMicros: 0, currency: "USD" },
    status: "active",
    metadata: {},
    createdAt: d(),
    updatedAt: d(),
...
export function subscriptionPlanFixture(
  ...
  return {
    ...
    name: "Pro",
    description: null,
    price: { amountMicros: 20_000_000, currency: "USD" },
    interval: "month",
    intervalCount: 1,
    includedCredit: { amountMicros: 10_000_000, currency: "USD" },
    includedTokens: 0,
    rateLimits: [
      {
        id: "rl1",
